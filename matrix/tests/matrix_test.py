...
class MatrixTest(unittest.TestCase):
    # Tests
    def setUp(self):
        self.square_matrix = Matrix("9 8 7\n5 3 2\n6 6 7")
        self.tall_matrix = Matrix("1 2 3\n4 5 6\n7 8 9\n8 7 6")
        self.wide_matrix = Matrix("1 2 3 4\n5 6 8 8\n9 8 7 6")
        self.irregular_matrix = Matrix("89 1903 3\n18 3 1\n9 4 800")
    ...
    def test_extract_row(self):
        self.assertEqual([9, 8, 7], self.square_matrix.row(1))
    ...
    def test_extract_row__non_square_matrix(self):
        self.assertEqual([8, 7, 6], self.tall_matrix.row(4))

    # Test can extract a column
    def test_extract_column(self):
        self.assertEqual([9, 5, 6], self.square_matrix.column(1))
    ...
    def test_extract_column__non_square_matrix(self):
        self.assertEqual([4, 8, 6], self.wide_matrix.column(4))
    ...
    def test_extract_column__irregular_matrix(self):
        self.assertEqual([1903, 3, 4], self.irregular_matrix.column(2))
